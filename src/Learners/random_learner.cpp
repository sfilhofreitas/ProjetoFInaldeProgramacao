...
RandomLearner::RandomLearner(HypothesesGenerator *hipGenerator, int seed){
    this->name = "RandomLearner";
...
vector<int> RandomLearner::get_h(const vector<int> & samples){
